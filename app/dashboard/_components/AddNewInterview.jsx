...
//        setJsonResponse(parsedResponse);
  ...
  return (
    <div>
      <div
        className="p-10 border rounded-lg   hover:scale-105 hover:shadow-md cursor-pointer
       transition-all"
                ...
                <div>
                  ...
                  <div className="mt-7 my-3">
                    ...
                    <Input
                      ...
                      required
                      className="mt-3  bg-blue-500/10  "
                      placeholder="Ex. Full Stack Developer"
                    />
                  </div>
                  <div className=" my-3">
                    <label className="font-extrabold" >Company Name (Optional)</label>
                    <Input
                  ...
                  <div className=" my-3">
                    <label className="font-extrabold" >Job Description</label>
                    <Textarea
                      className="mt-3  bg-blue-500/10"
                      required
                  ...
                  <div className=" my-3">
                    <label className="font-extrabold" >Year of experience </label>
                    <Input
                      className="mt-3 bg-blue-500/10"
                      placeholder="Ex. 2"
                      type="number"
